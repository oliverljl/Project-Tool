...
$.ajax({
	...
	{   
		...
		$.each($(json_file[count_3]),function(index,value){
			...
			each_div.setAttribute("class","div_section");
...
function print(){
	...
	{   
		...
		var divclass = document.getElementsByClassName("div_section");  		
		var count_5 =0;
		...
		divclass[count_5].style.display="none";
		}
		else{
		textid.style.display ="inline-block";
		imgid.style.display ="inline-block";
	    divclass[count_5].style.display="inline-block";
		}
		count_5++;
		}
	},
